...
export default LocateUsPageimport React from 'react'
import { MapPin, Navigation, Clock, Car, Phone, Mail, Building, Zap } from 'lucide-react'
import heroBackgroundImage from '@/assets/tron-hero-bg.jpg'
import { Button } from '@/components/ui/button'
  ...
  const landmarks = [
    {
      icon: Car,
      title: 'By Car',
      description: 'Take Gandhi Mandapam Road and enter the ISTE Complex through the main gate.',
      time: '15 mins from Chennai Airport',
      color: 'primary'
    },
    {
      icon: Navigation,
      title: 'Public Transport',
      description: 'Take the Chennai Metro/MRTS to the nearest station, then a short cab or auto-rickshaw ride to our Gandhi Mandapam Road office.',
      time: 'Nearby MRTS & Metro access',
      color: 'accent'
    },
    {
      icon: Clock,
      ...
      <section className="relative h-screen flex items-center justify-center overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="text-center mb-20">
            ...
            <p className="text-xl md:text-2xl text-muted-foreground max-w-4xl mx-auto leading-relaxed animate-fadeIn" style={{ animationDelay: '0.3s' }}>
              Navigate to the epicenter of automotive innovation at <span className="text-primary font-semibold">Gandhi Mandapam Road</span>, Chennai
            </p>
                    ...
                    <div className="relative">
                      <div className="flex items-start space-x-4">
                        ...
                        <div className="flex-1">
                          ...
                          <div className="bg-gradient-to-r from-accent/10 to-transparent p-4 rounded-lg border border-accent/20">
                            <p className="text-muted-foreground leading-relaxed text-lg">
                              <span className="text-accent font-semibold">NIELIT Chennai Centre</span><br />
                              <span className="text-primary">ISTE Complex, No. 25</span><br />
                              Gandhi Mandapam Road<br />
                              <span className="text-accent font-medium">Chennai, Tamil Nadu 600025</span>
                            </p>
                          </div>
                        </div>
                      </div>
                      ...
                      <div className="grid grid-cols-2 gap-4">
                        ...
                        <div className="relative group/card">
                          <div className="tron-glass p-5 rounded-lg border border-primary/30 hover:border-primary/50 transition-all duration-300 group-hover/card:tron-glow">
                            <div className="flex items-center gap-2 mb-2">
                              <div className="w-3 h-3 bg-primary rounded-full animate-pulse"></div>
                              <div className="text-sm text-muted-foreground font-orbitron">Locality</div>
                            </div>
                            <div className="font-bold text-accent text-lg">Gandhi Mandapam Rd</div>
                          </div>
                        </div>
                      </div>
                    </div>
